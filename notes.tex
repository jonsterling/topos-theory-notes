...
\begin{proof}
  ...
  exhibit the following bijection of hom-sets:
  \[
    \infer={
  ...
  We will construct the bijection of maps in the following diagrams;
...
%
  ...
  It is left as an exercise to the reader (or the author, when he
  finds time) to show that these transformations of arrows really
  constitute a bijection.
