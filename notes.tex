...
glueings''. Remarkably, we will see that this process is highly
well-behaved.
...
\begin{proof}
  ...
  and (unfolding the meaning of equality for a coend), and for all
  ...
  $\IsEqOf{\mathfrak{n}_1}{\mathfrak{n}_2\circ\mathfrak{l}}{[T_1,P]}$.
